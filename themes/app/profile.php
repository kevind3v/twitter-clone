...
<div class="modal fade" id="edit-profile" tabindex="-1" role="dialog" aria-labelledby="edit-profileTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered app-modal" role="document">
        <div class="modal-content">
            <form action="<?= $router->route('app.editProfile') ?>" class="form">
                ...
                <div class="modal-body p-0 profile-page">
                    <div class="banner" id="profile_banner">
                        ...
                        <label class="edit-photo" for="avatar">
                            <img id="profile_avatar" alt="<?= $user->user ?>" class="avatar" src="<?= (!empty($user->photo)) ? url($user->photo) : midias('img/profile.png') ?>" data-toggle="tooltip" data-placement="bottom" title="Mudar Foto" />
                        </label>
                    </div>
                    <div class="forms">
                        ...
                        <div class="form-group">
                            <textarea maxlength="160" name="bio" placeholder="Bio" id="bio" rows="4" class="form-control i-form"></textarea>
                            <label class="bio" for="bio">Bio</label>
                            <span class="count count-bio"><span>0</span>/160</span>
                        </div>
                        <div class="form-group">
                            <input id="location" name="location" placeholder="Localização" class="form-control i-form" type="text" />
